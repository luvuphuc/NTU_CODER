...
export default function Pagination({
  ...
  // Khởi tạo state cho pageSize và đồng bộ với props pageSize
  const [localPageSize, setLocalPageSize] = useState(pageSize ?? 5); // Mặc định là 5 nếu không truyền
        ...
        >
          ...
          <Select
            ...
            onChange={(e) => {
              ...
              onPageSizeChange?.(value); // Gọi nếu có truyền
            }}
            width={['100%', 'auto']}
            ml={0}
            variant="outline"
