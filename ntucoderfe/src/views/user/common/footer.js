...
export default function FooterUser() {
  return (
    <Box bg="#0186bd" color="white" py={8} px={6}>
      <Flex direction={{ base: 'column', md: 'row' }} justify="space-between" align="center" maxW="6xl" mx="auto">
        {/* Logo or Site Name */}
        ...
        {/* Navigation Links */}
        <Flex mt={{ base: 4, md: 0 }}>
          <Link mx={3} href="/about" _hover={{ color: 'gray.200' }}>Giới thiệu</Link>
          <Link mx={3} href="/terms" _hover={{ color: 'gray.200' }}>Điều khoản</Link>
          <Link mx={3} href="/contact" _hover={{ color: 'gray.200' }}>Liên hệ</Link>
        </Flex>
        ...
        <Flex mt={{ base: 4, md: 0 }}>
          ...
          <Link href="https://twitter.com" isExternal mx={2}>
            <Icon as={FaTwitter} boxSize={5} _hover={{ color: 'gray.200' }} />
          </Link>
