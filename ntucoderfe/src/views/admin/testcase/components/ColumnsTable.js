...
export default function TestCaseTable({
  ...
  const handleToggleStatus = async (testCaseID, field, currentValue) => {
    try {
      ...
      const response = await api.put(`/TestCase/${testCaseID}`, {
        [field]: newValue,
      });
    ...
    },
    {
      ...
      Cell: ({ row }) => (
        <Switch
          ...
          onChange={() =>
            handleToggleStatus(row.testCaseID, 'preTest', row.preTest)
          }
        />
      ),
    },
    {
      ...
      Cell: ({ row }) => (
        <Switch
          ...
          onChange={() =>
            handleToggleStatus(row.testCaseID, 'sampleTest', row.sampleTest)
          }
        />
      ),
    },
