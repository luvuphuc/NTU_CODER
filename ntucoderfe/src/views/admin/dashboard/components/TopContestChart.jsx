  ...
  if (active && payload && payload.length) {
    return (
      ...
      >
        ...
        <Text>
          {' '}
          Số lượt tham gia: {payload[0]?.payload?.participationCount}
        </Text>
      </Box>
    );
  }
...
export default function TopContestsChart() {
  ...
  useEffect(() => {
    api
      .get('/Statistic/top-contests?top=5')
      .then((res) => {
        setData(res.data);
      })
  ...
  return (
    ...
    >
      <Text
        ...
        color={textColor}
      >
        Top 5 cuộc thi được tham gia nhiều nhất
      </Text>
