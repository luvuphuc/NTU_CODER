...
import AnnouncementTable from './components/ColumnsTable';
import AnnouncementModal from './components/Create';
export default function AnnouncementIndexAdmin() {
  ...
  const [selectedAnnoucementId, setSelectedBlogID] = useState(null);
  const handleOpenCreateModal = () => {
    setSelectedBlogID(null);
    onOpen();
  };
  const handleOpenEditModal = (announcementID) => {
    setSelectedBlogID(announcementID);
    onOpen();
  };
      ...
      <Box pt={{ base: '130px', md: '80px', xl: '80px' }}>
        <Flex mb="20px" justifyContent="end" align="end" px="25px">
          ...
          <AnnouncementModal
            ...
            onClose={onClose}
            onDone={refetchData}
            announcementID={selectedAnnoucementId}
          />
        </Flex>
        <AnnouncementTable
          tableData={tableData}
